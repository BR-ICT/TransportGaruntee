...
<!--        <input type="checkbox" id="vDatagettype" name="datafromnum" value="datafromnum" onchange="LSchange()">
        <label for="txtPeriod">ข้อมูลคนขับรถที่ครบรอบไปแล้ว</label>-->
    ...
    <div class="wrap-test" style="width: 100%;margin-bottom: 0px;" id="modetransfer">   
        ...
        <input id="vLS" name="supplierchooser" list="supplierlist" style="width: 200px;" onchange="LSchange()">
...
//    $("#vDatagettype").change(function () {
//        LSchange();
//    });

//    $("#vLS").change(LSchange() )
    function LSchange() {
        var checkbox = document.getElementById("vDatagettype");
        var getcompleted = "";
        if (checkbox.checked) {
            getcompleted = "1";
        } else
